// pages/Index-releaseYfn/Index-releaseYfn.js
var app = getApp();
Page({
  ...
  onLoad: function (options) {
    ...
    let url = app.globalData.url + '/api/user/getUserSignup ';
    console.log(url)
    let data = {
      user_id: app.globalData.user_id
    };
  ...
  rearFn:function(e){
    wx.navigateTo({
      url: "../Index-releaseYfndeilt/Index-releaseYfndeilt",
    });
  },
  botreleaseFn:function(e){
    wx.navigateTo({
      url: "../Index-botreleaseFn/Index-botreleaseFn",
    });
  },
  /**
   * 生命周期函数--监听页面隐藏
